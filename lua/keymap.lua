...
map('i', 'jj', '<Esc>', { noremap =true }) -- toggle relative line numbers
map('', '<leader>co', ':CommentToggle<CR>', opt) -- toggle comment on current line or selection
map('', '<Space>e', ':NvimTreeToggle<CR>', opt) -- toggle nvimtree
map('n', '<C-t>nf', ':Neoformat<CR>', { noremap = true }) -- format current buffer with neoformat
